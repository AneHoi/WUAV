...
GO
INSERT INTO Case_ VALUES('Just an old case', 'They want to delete this case', (SELECT User_ID FROM User_ WHERE [User_Name] = 'PM'), 1, (SELECT User_ID FROM User_ Where [User_Name] = 'T1'), convert(date, '2003-9-14'))
GO
